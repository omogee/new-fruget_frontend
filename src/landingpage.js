        ...
        <div className='container-fluid' style={{backgroundColor:"rgba(245,245,245)",marginBottom:"100px",padding:"0",margin:"0",width:"100%"}}>
         ...
         {onlinepayment ?              
           ...
           <div className='row'>
            ...
            <center>
            <h1 style={{color:"white",fontWeight:"bold",textTransform:"uppercase",width:"50%"}}>
           ...
           <div className='container'>
            <button className='btn' style={{position:"fixed",zIndex:"90",bottom:"20px",right:"10px",backgroundColor:"orange",color:'white'}}>
                contact us
            </button>
            
            <div className="row" style={{padding:"10px"}}>
                <div className='col-12 col-md-8' style={{backgroundColor:"#007acc",color:'white',padding:"20px"}}>
                    <div>
                       ...
                       <div className='row' style={{padding:"20px"}}>
                        <div className='col-7 mt-2'>
                            <p><span className='fa fa-search fa-2x mr-1'></span> Identify your coverage needs</p><br/>
                            <p><span className='fa fa-calendar fa-2x mr-1'></span>Review Health Care Plans</p><br/>
                            <p><span className='fa fa-user fa-2x mr-1'></span> Speak With Our Insurance Advisors</p>
                        </div>
          ...
          <div className='row' style={{padding:"30px",height:"100%",display:"flex"}}>
              <div className='col-12 col-md-12 col-lg-4' style={{padding:"10px"}}>
                <p style={{fontSize:"30px",color:"black",fontWeight:"lighter"}}>Health Ins. Plans</p>
                <div>
  {plans.map(plan =>
                  ...
                  <div style={{backgroundColor:"white",width:"100%",marginBottom:"50px"}}>
                   <div className='container-fluid'>
                    ...
                    <div className='col-12 col-md-4 observeX'  style={{marginBottom:"40px",padding:"30px"}}>
                            <h5 style={{fontWeight:"lighter"}}>About Us</h5>
                            <p style={{fontWeight:"lighter"}}>View Our Profile</p>
                        ...
                        <div className='col-12 col-md-4 observeY'  style={{padding:"30px",marginBottom:"40px"}}>
                            <h5 style={{fontWeight:"lighter"}}>Our Policy/Plans</h5>
                            <p style={{fontWeight:"lighter"}}>view Our Policies</p>
                            <div onMouseOver={hoverapp} className={`${hovergrid} unhoveredapp`}>
                                <div style={{position:"relative"}}>
                                    <div className='underdiv' style={{position:"absolute",height:"100%",backgroundColor:"rgba(0,0,0,0.3)",width:"100%"}}>
                        ...
                        <br/><br/>
                        <div className='col-12 col-md-4 observeX'  style={{marginBottom:"40px",padding:"30px"}}>
                            <h3 style={{fontWeight:"lighter"}}>Our Binding Power </h3>
                            <p style={{fontWeight:"lighter"}}>View What Binds us</p>
                            <div onMouseOver={hoverapp} className={`${hovergrid} unhoveredapp`}>
                                <div style={{position:"relative"}}>
                                    <div className='underdiv' style={{position:"absolute",height:"100%",backgroundColor:"rgba(0,0,0,0.3)",width:"100%"}}>
